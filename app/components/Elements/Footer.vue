        ...
        <div class="gap-6 text-2xl mb-4 flex ">
          <a href="#">
            <svg
              ...
              class="lucide hover:text-gray-500 lucide-facebook-icon lucide-facebook"
            >
              <path
          ...
          <a href="#">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide hover:text-gray-500 lucide-instagram-icon lucide-instagram"
            >
          ...
          <a href="#">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide hover:text-gray-500 lucide-twitter-icon lucide-twitter"
            >
              <path
          ...
          <a href="#">
            <svg
              ...
              stroke-linecap="round"
              stroke-linejoin="round"
              class="lucide hover:text-gray-500 lucide-github-icon lucide-github"
            >
              <path
