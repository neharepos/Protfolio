            ...
            <div class="flex-1 w-full space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex flex-wrap items-center gap-3">
                        <h1 class="text-3xl md:text-5xl font-bold text-white tracking-tight">
                            Nish<span class="text-white md:text-zinc-400">ant Singh</span>
                        </h1>
                ...
                <div class="hidden md:block">
                    ...
                    <div class="space-y-3 mb-4">
                        <div class="flex items-center gap-3 text-zinc-300">
                            ...
                            <span>Data Analyst & Insight Lead <span class="text-zinc-500">@Company</span></span>
                        </div>
                        <div class="flex items-center gap-3 text-zinc-300">
                            <Lightbulb class="w-5 h-5 text-zinc-500" />
                            <span>Turning data into useful insights.</span>
                        </div>
                    </div>
                ...
                <div class="flex flex-col gap-4 md:hidden">
                    ...
                    <div class="font-mono text-sm text-zinc-400 leading-relaxed border-l-2 border-zinc-700 pl-3 mb-2">
                        <p>Data Analyst.</p>
                        <p>Turning data into useful insights.</p>
                    </div>
                    ...
                    <div class="flex items-center gap-4 group">
                        ...
                        <div class="font-mono text-sm">
                            <div class="text-zinc-200 font-bold">Data Analyst</div>
                    ...
                    <div class="flex items-center gap-4 group">
                        ...
                        <div class="font-mono text-sm text-zinc-200">Bangalore, India</div>
                    </div>
                    ...
                    <a href="tel:+917209879211" class="flex items-center gap-4 group">
                        ...
                        <div class="font-mono text-sm text-zinc-200">+91 720 987 9211</div>
                    </a>
                    ...
                    <a href="mailto:nishaantkrsingh@gmail.com" class="flex items-center gap-4 group">
                        ...
                        <div class="font-mono text-sm text-zinc-200">nishaantkrsingh@gmail.com</div>
                    </a>
                    ...
                    <a href="https://nishsingh.in" class="flex items-center gap-4 group">
                        ...
                        <div class="font-mono text-sm text-zinc-200">https://nishsingh.in</div>
                    </a>
                </div>
                <!-- End Mobile View -->
